...
You can use this feature a number of times equal to your Intelligence modifier (minimum of once). You regain all expended uses when you finish a long rest.",Reaction
Magic Item Adept,Magic,Artificier,4,10,,You can now attune to up to four magic items at once.,
Spell-Storing Item,Magic,Artificier,4,11,,"Whenever you finish a Long Rest, you can touch one Simple or Martial weapon or one item that you can use as a Spellcasting Focus, and you store a spell in it, choosing a level 1, 2, or 3 Artificer spell that has a casting time of an action and doesn't require a Material component that is consumed by the spell (you needn't have the spell prepared).
...
Magical Inspiration,Magic,Bard,2,2,,"At 2nd level, if a creature has a Bardic Inspiration die from you and casts a spell that restores hit points or deals damage, the creature can roll that die and choose a target affected by the spell. Add the number rolled as a bonus to the hit points regained or the damage dealt. The Bardic Inspiration die is then lost.",
...
Unbreakable Majesty,Magic,"Bard, College of Glamour",4,14,,"At 14th level, your appearance permanently gains an otherworldly aspect that makes you look more lovely and fierce.
...
Channel Divinity: Artisan's Blessing,Magic,"Cleric, Forge Domain",2,2,Channel Divinity,"Starting at 2nd level, you can use your Channel Divinity to create simple items.
...
Saint of Forge and Fire,Magic,"Cleric, Forge Domain",7,17,Soul of the Forge,"At 17th level, your blessed affinity with fire and metal becomes more powerful:
...
If the spell targets more than one ally, you choose the ally who can make the attack.",Reaction
...
Vigilant Blessing,Magic,"Cleric, Twilight Domain",4,1,,"At 1st level, the night has taught you to be vigilant. using 2 AP, you give one creature you touch (including possibly yourself) advantage on the next initiative roll the creature makes. This benefit ends immediately after the roll or if you use this feature again.",
Channel Divinity: Twilight Sanctuary,Magic,"Cleric, Twilight Domain",3,2,,"At 2nd level, you can use your Channel Divinity to refresh your allies with soothing twilight.

using 2 AP, you present your holy symbol, and a sphere of twilight emanates from you. The sphere is centered on you, has a 30-foot radius, and is filled with dim light. The sphere moves with you, and it lasts for 1 minute or until you are incapacitated or die. Whenever a creature (including you) ends its turn in the sphere, you can grant that creature one of these benefits:
...
You regain the expended dice when you finish a long rest.",1 AP
Hearth of Moonlight and Shadow,Magic,"Druid, Circle of Dreams",1,6,,"At 6th level, home can be wherever you are. During a short or long rest, you can invoke the shadowy power of the Gloaming Court to help guard your respite. At the start of the rest, you touch a point in space, and an invisible, 30-foot-radius sphere of magic appears, centered on that point. Total cover blocks the sphere.

While within the sphere, you and your allies gain a +5 bonus to Dexterity (Stealth) and Wisdom (Perception) checks, and any light from open flames in the sphere (a campfire, torches, or the like) isn't visible outside it.

The sphere vanishes at the end of the rest or when you leave the sphere.",
Hidden Paths,Magic,"Druid, Circle of Dreams",4,10,,"Starting at 10th level, you can use the hidden, magical pathways that some fey use to traverse space in a blink of an eye. using 1 AP on your turn, you can teleport up to 60 feet to an unoccupied space you can see. Alternatively, you can use your action to teleport one willing creature you touch up to 30 feet to an unoccupied space you can see.

You can use this feature a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses of it when you finish a long rest.",1 AP
Walker in Dreams,Magic,"Druid, Circle of Dreams",2,14,,"At 14th level, the magic of the Feywild grants you the ability to travel mentally or physically through dreamlands.
...
Nature's Ward,Magic,"Druid, Circle of Land",2,10,,"When you reach 10th level, you can't be charmed or frightened by elementals or fey, and you are immune to poison and disease.",
Nature's Sanctuary,Magic,"Druid, Circle of Land",1,14,,"When you reach 14th level, creatures of the natural world sense your connection to nature and become hesitant to attack you. When a beast or plant creature attacks you, that creature must make a Wisdom saving throw against your druid spell save DC. On a failed save, the creature must choose a different target, or the attack automatically misses. On a successful save, the creature is immune to this effect for 24 hours.

The creature is aware of this effect before it makes its attack against you.",
Combat Wild Shape,Magic,"Druid, Circle of Moon",2,2,Wild Shape,"When you choose this circle at 2nd level, you gain the ability to use Wild Shape on your turn using 1 AP, rather than using 2 AP.

Additionally, while you are transformed by Wild Shape, you can use 1 AP to expend one spell slot to regain 1d8 hit points per level of the spell slot expended.",1 AP
Circle Forms,Magic,"Druid, Circle of Moon",3,2,Combat Wild Shape,"The rites of your circle grant you the ability to transform into more dangerous animal forms. Starting at 2nd level, you can use your Wild Shape to transform into a beast with a challenge rating as high as 1. You ignore the Max. CR column of the Beast Shapes table, but must abide by the other limitations there.
...
Fungal Infestation,Magic,"Druid, Circle of Spores",1,6,,"At 6th level, your spores gain the ability to infest a corpse and animate it. If a beast or a humanoid that is Small or Medium dies within 10 feet of you, you can use your reaction to animate it, causing it to stand up immediately with 1 hit point. The creature uses the Zombie stat block in the Monster Manual. It remains animate for 1 hour, after which time it collapses and dies.

In combat, the zombie's turn comes immediately after yours. It obeys your mental commands, and the only action it can take is the Attack action, making one melee attack.

You can use this feature a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses of it when you finish a long rest.",Reaction
Spreading Spores,Magic,"Druid, Circle of Spores",1,10,Symbiotic Entity,"At 10th level, you gain the ability to seed an area with deadly spores. using 1 AP while your Symbiotic Entity feature is active, you can hurl spores up to 30 feet away, where they swirl in a 10-foot cube for 1 minute. The spores disappear early if you use this feature again, if you dismiss them using 1 AP, or if your Symbiotic Entity feature is no longer active.

Whenever a creature moves into the cube or starts its turn there, that creature takes your Halo of Spores damage, unless the creature succeeds on a Constitution saving throw against your spell save DC. A creature can take this damage no more than once per turn.

While the cube of spores persists, you can't use your Halo of Spores reaction.",1 AP
Fungal Body,Magic,"Druid, Circle of Spores",6,14,Halo of Spores,"At 14th level, the fungal spores in your body alter you: you can't be blinded, deafened, frightened, or poisoned, and any critical hit against you counts as a normal hit instead, unless you're incapacitated.",
Star Map,Magic,"Druid, Circle of Star",2,2,,,
Starry Form,Magic,"Druid, Circle of Star",4,2,Wild Shape,"At 2nd level, you gain the ability to harness constellations' power to alter your form. using 1 AP, you can expend a use of your Wild Shape feature to take on a starry form, rather than transforming into a beast.
...
You can use this reaction a number of times equal to your proficiency bonus, and you regain all expended uses when you finish a long rest.",Reaction
Twinkling Constellations,Magic,"Druid, Circle of Star",2,10,Starry Form,"At 10th level, the constellations of your Starry Form improve. The 1d8 of the Archer and the Chalice becomes 2d8, and while the Dragon is active, you have a flying speed of 20 feet and can hover.

Moreover, at the start of each of your turns while in your Starry Form, you can change which constellation glimmers on your body.",
Full of Stars,Magic,"Druid, Circle of Star",5,14,,"At 14th level, while in your Starry Form, you become partially incorporeal, giving you resistance to bludgeoning, piercing, and slashing damage.",
Speech of the woods,Magic,"Druid, Circle of the Shepherd",1,2,,"At 2nd level, you gain the ability to converse with beasts and many fey.

You learn to speak, read, and write Sylvan. In addition, beasts can understand your speech, and you gain the ability to decipher their noises and motions. Most beasts lack the intelligence to convey or understand sophisticated concepts, but a friendly beast could relay what it has seen or heard in the recent past. This ability doesn’t grant you any special friendship with beasts, though you can combine this ability with gifts to curry favor with them as you would with any nonplayer character.",
Spirit Totem,Magic,"Druid, Circle of the Shepherd",3,2,,"Starting at 2nd level, you gain the ability to call forth nature spirits and use them to influence the world around you.

using 1 AP, you can magically summon an incorporeal spirit to a point you can see within 60 feet of you. The spirit creates an aura in a 30-foot radius around that point. It counts as neither a creature nor an object, though it has the spectral appearance of the creature it represents. using 1 AP, you can move the spirit up to 60 feet to a point you can see.
...
Guardian Spirit,Magic,"Druid, Circle of the Shepherd",2,10,Spirit Totem,"Beginning at 10th level, your Spirit Totem safeguards the beasts and fey that you call forth with your magic. When a beast or fey that you summoned or created with a spell ends its turn in your Spirit Totem aura, that creature regains a number of hit points equal to half your druid level.",
...
In combat, the spirit shares your initiative count, but it takes its turn immediately after yours. The only action it takes on its turn is the Dodge action, unless you can use 1 AP on your turn to command it to take another action. That action can be one in its stat block or some other action. If you are incapacitated, the spirit can take any action of its choice, not just Dodge.

The spirit manifests for 1 hour, until it is reduced to 0 hit points, until you use this feature to summon the spirit again, or until you die.","2 AP, 1 AP"
Enhanched Bond,Magic,"Druid, Circle of Wildfire",2,6,Summon Wild Spirit,"At 6th level, the bond with your wildfire spirit enhances your destructive and restorative spells. Whenever you cast a spell that deals fire damage or restores hit points while your wildfire spirit is summoned, roll a d8, and you gain a bonus equal to the number rolled to one damage or healing roll of the spell.

In addition, when you cast a spell with a range other than self, the spell can originate from you or your wildfire spirit.",
Cauterizing Flames,Magic,"Druid, Circle of Wildfire",1,10,,"At 10th level, you gain the ability to turn death into magical flames that can heal or incinerate. When a Small or larger creature dies within 30 feet of you or your wildfire spirit, a harmless spectral flame springs forth in the dead creature's space and flickers there for 1 minute. When a creature you can see enters that space, you can use your reaction to extinguish the spectral flame there and either heal the creature or deal fire damage to it. The healing or damage equals 2d10 + your Wisdom modifier.

You can use this reaction a number of times equal to your proficiency bonus, and you regain all expended uses when you finish a long rest.",Reaction
Blazing Revival,Magic,"Druid, Circle of Wildfire",2,14,Summon Wild Spirit,"At 14th level, the bond with your wildfire spirit can save you from death. If the spirit is within 120 feet of you when you are reduced to 0 hit points and thereby fall unconscious, you can cause the spirit to drop to 0 hit points. You then regain half your hit points and immediately rise to your feet.

Once you use this feature, you can't use it again until you finish a long rest.",
Second Wind,Combat,Fighter,3,1,,"You have a limited well of stamina that you can draw on to protect yourself from harm. On your turn, you can use 1 AP to regain hit points equal to 1d10 + your fighter level.

Once you use this feature, you must finish a short or long rest before you can use it again.",1 AP
...
Royal Envoy,Combat,"Fighter, Banneret",2,7,,"Knights of high standing are expected to conduct themselves with grace.
...
Inspiring Surge,Combat,"Fighter, Banneret",4,10,Action Surge,"Starting at 10th level, when you use your Action Surge feature, you can choose one creature within 60 feet of you that is allied with you. That creature can make one melee or ranged weapon attack with its reaction, provided that it can see or hear you.
...
Superior Critical,Combat,"Fighter, Champion",5,15,Improved Critical,"Starting at 15th level, your weapon attacks score a critical hit on a roll of 18-20",
Survivor,Combat,"Fighter, Champion",3,18,,"At 18th level, you attain the pinnacle of resilience in battle. At the start of each of your turns, you regain hit points equal to 5 + your Constitution modifier if you have no more than half of your hit points left. You don't gain this benefit if you have 0 hit points.",
Manifest Echo,Magic,"Fighter, Echo Knight",3,1,,"At 3rd level, you can use 1 AP to magically manifest an echo of yourself in an unoccupied space you can see within 15 feet of you. This echo is a magical, translucent, gray image of you that lasts until it is destroyed, until you dismiss it using 1 AP, until you manifest another echo, or until you're incapacitated.
Your echo has AC 14 + your proficiency bonus, 1 hit point, and immunity to all conditions. If it has to make a saving throw, it uses your saving throw bonus for the roll. It is the same size as you, and it occupies its space. On your turn, you can mentally command the echo to move up to 30 feet in any direction (no action required). If your echo is ever more than 30 feet from you at the end of your turn, it is destroyed.
• using 1 AP, you can teleport, magically swapping places with your echo at a cost of 15 feet of your movement, regardless of the distance between the two of you.
• When you take the Attack action on your turn, any attack you make with that action can originate from your space or the echo's space. You make this choice for each attack.
• When a creature that you can see within 5 feet of your echo moves at least 5 feet away from it, you can use your reaction to make an opportunity attack against that creature as if you were in the echo's space.","1 AP, Reaction"
Unleash Incarnation,Magic,"Fighter, Echo Knight",4,3,Manifest Echo,"At 3rd level, you can heighten your echo's fury. Whenever you take the Attack action, you can make one additional melee attack from the echo's position.

You can use this feature a number of times equal to your Constitution modifier (a minimum of once). You regain all expended uses when you finish a long rest.",
Echo Avatar,Magic,"Fighter, Echo Knight",1,7,Manifest Echo,"Starting at 7th level, you can temporarily transfer your consciousness to your echo. using 2 AP, you can see through your echo's eyes and hear through its ears. During this time, you are deafened and blinded. You can sustain this effect for up to 10 minutes, and you can end it at any time (requires no action). While your echo is being used in this way, it can be up to 1,000 feet away from you without being destroyed.",2 AP
Shadow Martyr,Magic,"Fighter, Echo Knight",3,10,Manifest Echo,"Starting at 10th level, you can make your echo throw itself in front of an attack directed at another creature that you can see. Before the attack roll is made, you can use your reaction to teleport the echo to an unoccupied space within 5 feet of the targeted creature. The attack roll that triggered the reaction is instead made against your echo.

Once you use this feature, you can't use it again until you finish a short or long rest.",Reaction
Reclaim Potential,Magic,"Fighter, Echo Knight",3,15,Manifest Echo,"By 15th level, you've learned to absorb the fleeting magic of your echo. When an echo of yours is destroyed by taking damage, you can gain a number of temporary hit points equal to 2d6 + your Constitution modifier, provided you don't already have temporary hit points.

You can use this feature a number of times equal to your Constitution modifier (a minimum of once). You regain all expended uses when you finish a long rest.",
Legion of One,Magic,"Fighter, Echo Knight",4,18,Manifest Echo,"At 18th level, you can use 1 AP to create two echos with your Manifest Echo feature, and these echoes can co-exist. If you try to create a third echo, the previous two echoes are destroyed. Anything you can do from one echo's position can be done from the other's instead.

In addition, when you roll initiative and have no uses of your Unleash Incarnation feature left, you regain one use of that feature.",1 AP
Weapon Bond,Magic,"Fighter, Eldritch knight",1,3,,"At 3rd level, you learn a ritual that creates a magical bond between yourself and one weapon. You perform the ritual over the course of 1 hour, which can be done during a short rest. The weapon must be within your reach throughout the ritual, at the conclusion of which you touch the weapon and forge the bond.

Once you have bonded a weapon to yourself, you can't be disarmed of that weapon unless you are incapacitated. If it is on the same plane of existence, you can summon that weapon using 1 AP on your turn, causing it to teleport instantly to your hand.

You can have up to two bonded weapons, but can summon only one at a time with 1 AP. If you attempt to bond with a third weapon, you must break the bond with one of the other two.",1 AP
War Magic,Magic,"Fighter, Eldritch knight",3,7,,"Beginning at 7th level, when you use your action to cast a cantrip, you can make one weapon attack using 1 AP.",1 AP
...
Great Stature,Magic,"Fighter, Rune Knight",1,10,Giant Might,"By 10th level, the magic of your runes permanently alters you. When you gain this feature, roll 3d4. You grow a number of inches in height equal to the roll.

Moreover, the extra damage you deal with your Giant's Might feature increases to 1d8.",
Master of Runes,Magic,"Fighter, Rune Knight",3,15,Rune Carver,"At 15th level, you can invoke each rune you know from your Rune Carver feature twice, rather than once, and you regain all expended uses when you finish a short or long rest.",
Runic Juggernaut,Magic,"Fighter, Rune Knight",3,18,,"At 18th level, you learn how to amplify your rune-powered transformation. As a result, the extra damage you deal with the Giant's Might feature increases to 1d10. Moreover, when you use that feature, your size can increase to Huge, and while you are that size, your reach increases by 5 feet.",
Samurai Bonus Proficiency,"General, Skill","Fighter, Samurai",1,3,,"When you choose this archetype at 3rd level, you gain proficiency in one of the following skills of your choice: History, Insight, Performance, or Persuasion. Alternatively, you learn one language of your choice.",
Fighting Spirit,Combat,"Fighter, Samurai",7,3,,"Starting at 3rd level, your intensity in battle can shield you and help you strike true. using 1 AP on your turn, you can give yourself advantage on all weapon attack rolls until the end of the current turn. When you do so, you also gain 5 temporary hit points. The number of hit points increases when you reach certain levels in this class, increasing to 10 at 10th level and 15 at 15th level.

You can use this feature three times. You regain all expended uses of it when you finish a long rest.",1 AP
Elegant Courtier,General,"Fighter, Samurai",4,7,,"Starting at 7th level, your discipline and attention to detail allow you to excel in social situations. Whenever you make a Charisma (Persuasion) check, you gain a bonus to the check equal to your Wisdom modifier.

Your self-control also causes you to gain proficiency in Wisdom saving throws. If you already have this proficiency, you instead gain proficiency in Intelligence or Charisma saving throws (your choice).",
Tireless Spirit,Combat,"Fighter, Samurai",3,10,Fighting Spirit,"Starting at 10th level, when you roll initiative and have no uses of Fighting Spirit remaining, you regain one use.",
Rapid Strike,Combat,"Fighter, Samurai",3,15,,"Starting at 15th level, you learn to trade accuracy for swift strikes. If you take the Attack action on your turn and have advantage on an attack roll against against one of the targets, you can forgo the advantage for that roll to make an additional weapon attack against that target, as part of the same action. You can do so no more than once per turn.",
...
• When you use the Attack action with an unarmed strike or a monk weapon on your turn, you can make one unarmed strike using 1 AP. For example, if you take the Attack action and attack with a quarterstaff, you can also make an unarmed strike using 1 AP.
...
• The unarmed strikes you make with the arms can use your Wisdom modifier in place of your Strength or Dexterity modifier for the attack and damage rolls, and their damage type is force.",1 AP
Visage of the Astral Self,Magic,"Monk, Way of the Astral Self",2,6,Arms of the Astral Self,"As 1 Action Point, you can make one attack with a weapon or an Unarmed Strike. You can use this Action a number of times equal to your Wisdom modifier (minimum of once). You regain all expended uses when you finish a Short or Long Rest.",
Body of the Astral Self,Magic,"Monk, Way of the Astral Self",2,11,,"When you have both your astral arms and visage summoned, you can cause the body of your astral self to appear (no action required). This spectral body covers your physical form like a suit of armor, connecting with the arms and visage. You determine its appearance.
...
Each creature in the Sphere must make a Dexterity saving throw. On a failed save, a creature takes damage of the chosen type equal to three rolls of your Martial Arts die. On a successful save, a creature takes half as much damage.",2 AP
...
Lay on Hands,Magic,Paladin,3,1,,"Your blessed touch can heal wounds. You have a pool of healing power that replenishes when you finish a Long Rest. With that pool, you can restore a total number of Hit Points equal to five times your Paladin level.

As 1 AP, you can touch a creature (which could be yourself) and draw power from the pool of healing to restore a number of Hit Points to that creature, up to the maximum amount remaining in the pool.
...
Abjure Foes,Combat,Paladin,3,9,,"As a Magic action, you can expend one use of this class's Channel Divinity to overwhelm foes with awe. As you present your Holy Symbol or weapon, you can target a number of creatures equal to your Charisma modifier (minimum of one creature) that you can see within 60 feet of yourself. Each target must succeed on a Wisdom saving throw or have the Frightened condition for 1 minute or until it takes any damage. While Frightened in this way, a target is also Dazed.",2 AP
Aura of Courage,Magic,Paladin,2,10,Aura of Protection,"You and your allies are immune to the Frightened condition while in your Aura of Protection. If a Frightened ally enters the aura, that condition has no effect on that ally while there.",
...
• Whenever you cast a paladin spell that has a casting time of  2 AP, you can cast it using 1 AP instead.
...
Mortal Bulwark,Magic,"Paladin, Watchers",8,20,Aura of Protection,"At 20th level, you manifest a spark of divine power in defense of the mortal realms. using 1 AP, you gain the following benefits for 1 minute:
...
Precise Hunter,Combat,Ranger,3,17,Favored Enemy,You have Advantage on attack rolls agains the creature currently marked by your Hunter's Mark.,
Feral Sense,General,Ranger,4,18,,You gain Blindsense 30ft.,
Foe Slayer,General,Ranger,4,20,Favored Enemy,"At 20th level, you become an unparalleled hunter of your enemies. Once on each of your turns, you can add your Wisdom modifier to the attack roll or the damage roll of an attack you make against one of your favored enemies. You can choose to use this feature before or after the roll, but before any effects of the roll are applied.",
Draconic Gift,Magic,"Ranger, Drakewarden",1,3,,"At 3rd level, the bond you share with your drake creates a connection to dragonkind, granting you understanding and empowering your presence.
...
Fey Reinforcements,Magic,"Ranger, Fey Wander",5,11,,"You can cast Summon Fey without a Material component. You can also cast it once without a spell slot, and you regain the ability to cast it in this way when you finish a Long Rest.
...
Misty Wanderer,Magic,"Ranger, Fey Wander",3,15,,"You can cast Misty Step without expending a spell slot. You can do so a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses when you finish a Long Rest.
...
Ethereal Step,Magic,"Ranger, Horizon Walker",4,7,,"At 7th level, you learn to step through the Ethereal Plane. using 1 AP on your turn, you can cast the Etherealness spell with this feature, without expending a spell slot, but the spell ends at the end of the current turn.

Once you use this feature, you can’t use it again until you finish a short or long rest.",1 AP
Distant Strike,Magic,"Ranger, Horizon Walker",4,11,,"At 11th level, you gain the ability to pass between the planes in a blink of an eye. When you use the Attack action, you can teleport up to 10 feet before each attack to an unoccupied space you can see.
...
Mighty Swarm,Magic,"Ranger, Swarmkeeper",3,11,Gathered Swarm,"At 11th level, your Gathered Swarm grows mightier in the following ways:
...
Reliable Talent,"General, Skill",Rogue,4,11,,"By 11th level, you have refined your chosen skills until they approach perfection. Whenever you make an ability check that lets you add your proficiency bonus, you can treat a d20 roll of 9 or lower as a 10.",
Slippery mind,General,Rogue,5,15,,"By 15th level, you have acquired greater mental strength. You gain proficiency in Wisdom and Charisma saving throws.",
Elusive,Combat,Rogue,4,18,,"Beginning at 18th level, you are so evasive that attackers rarely gain the upper hand against you. No attack roll has advantage against you while you aren't incapacitated.",
Stroke of Luck,Combat,Rogue,4,20,,"At 20th level, you have an uncanny knack for succeeding when you need to. If your attack misses a target within range, you can turn the miss into a hit. Alternatively, if you fail an ability check, you can treat the d20 roll as a 20.
Once you use this feature, you can't use it again until you finish a short or long rest.",
Mage Hand Legerdemain,Magic,"Rogue, Arcane Trickster",2,3,Cunning Action,"When you cast Mage Hand, you can cast it as 1AP , and you can make the spectral hand Invisible. You can control the hand with 1 AP, and through it, you can make Dexterity (Sleight of Hand) checks.",1 AP
Magic Ambush,Magic,"Rogue, Arcane Trickster",5,9,,"If you have the Invisible condition when you cast a spell on a creature, it has Disadvantage on any saving throw it makes against the spell on the same turn.",
Versatile Trickster,Magic,"Rogue, Arcane Trickster",3,13,Mage Hand Legerdemain,"You gain the ability to distract targets with your Mage Hand. When you use the Trip option of your Cunning Strike on a creature, you can also use that option on another creature within 5 feet of the spectral hand.",1 AP
Spell Thief,Magic,"Rogue, Arcane Trickster",2,17,,"You gain the ability to magically steal the knowledge of how to cast a spell from another spellcaster.
...
You can use this feature a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses of it when you finish a long rest.",2 AP
Eye of Weakness,General,"Rogue, Inquisitive",4,17,Insightful Fighting,"At 17th level, you learn to exploit a creature's weaknesses by carefully studying its tactics and movement. While your Insightful Fighting feature applies to a creature, your Sneak Attack damage against that creature increases by 3d6.",
Master of Intrigue,General,"Rogue, Mastermind",1,3,,"When you choose this archetype at 3rd level, you gain proficiency with the disguise kit, the forgery kit, and one gaming set of your choice. You also learn two languages of your choice.

Additionally, you can unerringly mimic the speech patterns and accent of a creature that you hear speak for at least 1 minute, enabling you to pass yourself off as a native speaker of a particular land, provided that you know the language.",
Master of Tactics,General,"Rogue, Mastermind",3,3,,"Starting at 3rd level, you can use the Help action using 1 AP. Additionally, when you use the Help action to aid an ally in attacking a creature, the target of that attack can be within 30 feet of you, rather than 5 feet of you, if the target can see or hear you.",1 AP
Insightful Manipulator,General,"Rogue, Mastermind",1,9,,"Starting at 9th level, if you spend at least 1 minute observing or interacting with another creature outside combat, you can learn certain information about its capabilities compared to your own. The DM tells you if the creature is your equal, superior, or inferior in regard to two of the following characteristics of your choice:
...
Misdirection,General,"Rogue, Mastermind",1,13,,"Beginning at 13th level, you can sometimes cause another creature to suffer an attack meant for you. When you are targeted by an attack while a creature within 5 feet of you is granting you cover against that attack, you can use your reaction to have the attack target that creature instead of you.",Reaction
Soul of Deceit,General,"Rogue, Mastermind",1,17,,"Starting at 17th level, your thoughts can't be read by telepathy or other means, unless you allow it. You can present false thoughts by making a Charisma (Deception) check contested by the mind reader's Wisdom (Insight) check.

Additionally, no matter what you say, magic that would determine if you are telling the truth indicates you are being truthful if you so choose, and you can't be compelled to tell the truth by magic.",
Whispers of the Dead,"General, Skill","Rogue, Phantom",1,3,,"When you choose this archetype at 3rd level, echoes of those who have died cling to you. Whenever you finish a short or long rest, you can gain one skill or tool proficiency of your choice, as a ghostly presence shares its knowledge with you. You lose this proficiency when you use this feature to choose a different proficiency that you lack.",
...
• using 2 AP, you can destroy one of your soul trinkets, no matter where it's located. When you do so, you can ask the spirit associated with the trinket one question. The spirit appears to you and answers in a language it knew in life. It's under no obligation to be truthful, and it answers as concisely as possible, eager to be free. The spirit knows only what it knew in life, as determined by the DM.",Reaction
Ghost Walk,Magic,"Rogue, Phantom",4,13,Token of the Departed,"you can phase partially into the realm of the dead, becoming like a ghost. using 1 AP, you assume a spectral form. While in this form, you have a flying speed of 10 feet, you can hover, and attack rolls have disadvantage against you. You can also move through creatures and objects as if they were difficult terrain, but you take 1d10 force damage if you end your turn inside a creature or an object.

You stay in this form for 10 minutes or until you end it using 1 AP. To use this feature again, you must finish a long rest or destroy one of your soul trinkets as part of the action you use to activate Ghost Walk.",1 AP
Death's Friend,Magic,"Rogue, Phantom",2,17,Wails from the Grave,"At 17th level, your association with death has become so close that you gain the following benefits:
...
Once you use this feature, you can't do so again until you finish a Long Rest unless you expend a Psionic Energy Die (no action required) to restore your use of it.",2 AP
...
Dragon Wings,Magic,"Sorcerer, Draconic Bloodline",4,14,,"As a 1 Action Point, you can cause draconic wings to appear on your back. The wings last for 1 hour or until you dismiss them (no action required). For the duration, you have a Fly Speed of 60 feet.

Once you use this feature, you can't use it again until you finish a Long Rest unless you spend 3 Sorcery Points (no action required) to restore your use of it.",1 AP
...
You also gain a magical flying speed of 60 feet. using 2 AP, you can reduce your flying speed to 30 feet for 1 hour and choose a number of creatures within 30 feet of you equal to 3 + your Charisma modifier. The chosen creatures gain a magical flying speed of 30 feet for 1 hour. Once you reduce your flying speed in this way, you can't do so again until you finish a short or long rest.",2 AP
...
If the target is Small or larger and is not a Construct, Elemental, Plant, or Undead, you gain the following benefits:
...
Immortal blood,General,Vampire,5,14,Blood Power,"You use your familiarity with death to escape its grasp.
When you are reduced to 0 hit points, you can expend a number of Blood Points up to your Charisma modifier (minimum of 1, no action required). You regain 20 hit points for each ki point spent.
You cannot use this feature if you are incapacitated.",No AP
...
True Seeing,Magic,"Vampire, Auspex",4,12,Vampire Sight; Blindsight,"When you active the Blindsight power or during the duration of Blindsight abily using 2 AP, he can use 2 B.P. and he gain Truesight 60ft for 10 minutes.",2 AP
Vampire Scan,Magic,"Vampire, Auspex",5,15,Vampire Sight; Blindsight,using 1 AP the vampire can spend 1 B.P. e creare un’esplosione che scansiona tutto quello che si trova entro i 30ft di raggio dalla sua posizione. Qualsiasi creatura o oggetto nascosto o invisibile viene automaticamente rilevata dal Vampiro che viene esattamente a conoscenza della sua posizione.,1 AP
Foresight,Magic,"Vampire, Auspex",5,18,Vampire Sight; Blindsight,"When you active the Blindsight power or during the duration of Blindsight abily using 2 AP, you can use 3 B.P. to obtain a special sense. For a number of times equal to its proficiency + your charisma modifier, you can reroll a D20 test or you can impose a Disadvantage roll against you on one attack roll.",2 AP
Vampire movement,Combat,"Vampire, Celeritas",4,3,,"As monk ability except for the 9th level improvement.
Bonus of speed +",
Evasion,Combat,"Vampire, Celeritas",3,6,,"When you are subjected to an effect that allows you to make a Dexterity saving throw to take only half damage, you instead take no damage if you succeed on the saving throw, and only half damage if you fail.",
Haste,Magic,"Vampire, Celeritas",5,9,,"Usando 2 AP e 3 Punti Sangue, il vampiro ottiene la condizione Quickened per 1 minuto.",2 AP
Quick Reaction,Combat,"Vampire, Celeritas",3,12,,When you roll initiative you can spend 1 B.P. to have advantage on initiative check,
...
-When you use the Attack action with a claw, you can make one claw strike using 1 AP. If you use 1 B.P.  to make the Extra Claw Attack, you can do 2 claws attack using 1 AP",1 AP
Grappling Claw,Combat,"Vampire, Ferox",2,6,Vampire claw,"When the vampire hit with his claw, he can automatically grapple (Escape CD 8+prof.+mod For or Dex) the creature if it is not more than one larger size.",
...
Terrible Strike,Combat,"Vampire, Potentia",4,12,Power Attack,when use Power Attack the vampire can spend 1 B.P. extra e un attacco con un’arma da mischia (o naturale da mischia) o da lancio hanno il dado massimizzato. Utilizzabile solo su un attacco per round.,
Killer Strike,Combat,"Vampire, Potentia",5,15,Power Attack,"quando usa Power Attack e colpisce un avversario, the vampire can spend 1 B.P. and the next attack is critical. 
Se invece l'attacco non colpisce, spendendo 1 B.P. l'attacco va a segno.
The vampire can use this ability only one time per round.",
Legendary Blood Strenght,Combat,"Vampire, Potentia",4,18,Blood Strenght,"using 1 AP, the vampire can spend 2B.P. and increase Strenght by 4 for 1 minute.",1 AP
Vampire Hardness,General,"Vampire, Robur",3,3,Blood Power,Spendendo 1 PS si ottieni 2 hit points temporanei per livello da vampiro,
Perfect Constitution,General,"Vampire, Robur",3,6,Blood Power,"When you are subjected to an effect that allows you to make a Constitution saving throw to take only half damage, you can spend 1B.P: as a free action instead take no damage if you succeed on the saving throw, and only half damage if you fail.",
Legendary Resistance,Combat,"Vampire, Robur",4,9,Blood Power,"If the vampire fails a saving throw, 1 time per day it can spend 2 B.P. and choose to succeed instead. You can use this ability 2 times at 11 level, 3 times at 14 level, 4 times at 17 level, 5 times at 20 level.
The vampire regain all the uses after long rest.",
Perfection of blood,General,"Vampire, Robur",3,12,Blood Power,"The Vampire can use 3 B.P. using 2 AP to end a condition suffered (Blinded, Confused, Dazed, Deafened, Exhaustion 1 level, Frightened, Incapacitated, Paralyzed, Poisoned, Stunned)",2 AP
Legendary Blood Resistance,General,"Vampire, Robur",5,15,Blood Power,"Using 1 AP you can expend 3 Blood Point to bolster yourself against harm for 1 minute or until you have the Incapacitated condition. During that time, you have Resistance to all damage except Radiant damage.",1 AP
...
Lord of Darkness,Magic,"Vampire, Tenebris",5,18,Darkness,"using 2 AP you can use 3 B.P. and emit an up to 60ft radius sphere of dim-light or darkness that spreads around corners. The sphere extinguishes non-magical lights within the area, and cannot otherwise be illuminated. The sphere dissipates if you hit 0 hp, or if you dismiss it using 2 AP. Creatures of your choice within the sphere can see through both magical and non-magical darkness. Once per turn, while you are within the sphere, you can use a feature which requires you to be in dim light or darkness as a free action.",2 AP
Hellish Weapon,Combat,"Vampire, Toxicus",3,3,Blood Power,Spendendo 1 PS si ottiene un bonus al danno di 1d6 da veleno per 1 minuto.,
Toxic Blood,Combat,"Vampire, Toxicus",3,6,Blood Power,"spendendo 1 PS con 1 AP per un minuto, A creature that touches the Vampire or hits it with a melee attack while within 5 feet of it takes (1d6) poison damage.",1 AP
Poison Split,Combat,"Vampire, Toxicus",4,9,Toxic Blood,2 AP: 1 B.p. Poison Split: Ranged Hit 15/30ft. The Target takes 4d6 poison damage +4d6 for each PS expended. The target must succed a TS on Cos (CD 8+prof+COS) or be paralyzed for 1 round.,2AP
Improved Hellish Weapon,Combat,"Vampire, Toxicus",3,12,Hellish Weapon,"When the vampire attacks with his Hellish Weapon, the target must succeed on a DC (8+prof+COS) Constitution saving throw or become poisoned. The poisoned target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.",
Cursed Poison,Combat,"Vampire, Toxicus",5,15,Improved Hellish Weapon,"While is poisoned by the attack of an Improved Hellish Weapon, the creature is also Cursed.
...
Bewitching Magic,Magic,"Warlock, Archfey",2,14,Step of fey,"Your patron grants you the ability to weave your magic with teleportation. Immediately after you cast an Enchantment or Illusion spell using an action and a spell slot, you can cast Misty Step as part of the same action and without expending a spell slot.",
"Expandend list, Celestial",Magic,"Warlock, Celestial",3,3,,,
Healing Light,Magic,"Warlock, Celestial",3,3,,"You gain the ability to channel celestial energy to heal wounds. You have a pool of d6s to fuel this healing. The number of dice in the pool equals 1 plus your Warlock level.

As a 1 AP, you can heal yourself or one creature you can see within 60 feet of yourself, expending dice from the pool. The maximum number of dice you can expend at once equals your Charisma modifier (minimum of one die). Roll the dice you expend, and restore a number of Hit Points equal to the roll's total. Your pool regains all expended dice when you finish a Long Rest.",1 AP
Radiant Soul,Magic,"Warlock, Celestial",3,6,,"Your link to your patron allows you to serve as a conduit for radiant energy. You have Resistance to Radiant damage. Once per turn, when a spell you cast deals Radiant or Fire damage, you can add your Charisma modifier to that spell's damage against one of the spell's targets.",
...
Fiendish Resilience,Magic,"Warlock, Fiend",2,10,,"Choose one damage type, other than Force, whenever you finish a Short or Long Rest. You have Resistance to that damage type until you choose a different one with this feature.",
...
If the vessel is destroyed or you lose it, you can perform a 1-hour ceremony to receive a replacement from your patron. This ceremony can be performed during a short or long rest, and the previous vessel is destroyed if it still exists. The vessel vanishes in a flare of elemental power when you die.","2 AP, 1 AP"
Elemental Gift,Magic,"Warlock, Genie",4,6,,"At 6th level, you begin to take on characteristics of your patron's kind. You now have resistance to a damage type determined by your patron's kind: bludgeoning (dao), thunder (djinni), fire (efreeti), or cold (marid).

In addition, using 1 AP, you can give yourself a flying speed of 30 feet that lasts for 10 minutes, during which you can hover. You can use this action a number of times equal to your proficiency bonus, and you regain all expended uses when you finish a long rest.",1 AP
Sancutary Vessel,Magic,"Warlock, Genie",4,10,,"At 10th level, when you enter your Genie's Vessel via the Bottled Respite feature, you can now choose up to five willing creatures that you can see within 30 feet of you, and the chosen creatures are drawn into the vessel with you.

using 1 AP, you can eject any number of creatures from the vessel, and everyone is ejected if you leave or die or if the vessel is destroyed.

In addition, anyone (including you) who remains within the vessel for at least 10 minutes gains the benefit of finishing a short rest, and anyone can add your proficiency bonus to the number of hit points they regain if they spend any Hit Dice as part of a short rest there.",1 AP
...
Eldritch Hex,Magic,"Warlock, Great old one",2,10,Spell casting,"Your alien patron grants you a powerful curse. You always have the Hex spell prepared. When you cast Hex and choose an ability, the target also has Disadvantage on saving throws of the chosen ability for the duration of the spell.",
Thought Shield,Magic,"Warlock, Great old one",4,10,,"Your thoughts can't be read by telepathy or other means unless you allow it. You also have Resistance to Psychic damage, and whenever a creature deals Psychic damage to you, that creature takes the same amount of damage that you take.",
...
Necrotic Husk,Magic,"Warlock, Undead",2,10,,"At 10th level, Your connection to undeath and necrotic energy now saturates your body. You have resistance to necrotic damage. If you are transformed using your Form of Dread, you instead become immune to necrotic damage.

In addition, when you are reduced to 0 hit points, you can use your reaction to drop to 1 hit point instead and cause your body to erupt with deathly energy. Each creature of your choice that is within 30 feet of you takes necrotic damage equal to 2d10 + your warlock level. You then gain 1 level of exhaustion. Once you use this reaction, you can’t do so again until you finish 1d4 long rests.",Reaction
Spirit Projection,Magic,"Warlock, Undead",5,14,,"At 14th level, your spirit can become untethered from your physical form. using 2 AP, you can project your spirit from your body. The body you leave behind is unconscious and in a state of suspended animation.
...
Arcane Recovery,Magic,Wizard,3,1,,"You have learned to regain some of your magical energy by studying your spellbook. Once per day when you finish a short rest, you can choose expended spell slots to recover. The spell slots can have a combined level that is equal to or less than half your wizard level (rounded up), and none of the slots can be 6th level or higher.
...
You can use this ability twice, and you regain any expended uses when you finish a long rest.",Reaction
Temporal Awareness,Magic,"Wizard, Chronurgy Magic",6,2,,"Starting at 2nd level, you can add your Intelligence modifiers to your initiative rolls.",
Momentary Stasis,Magic,"Wizard, Chronurgy Magic",2,6,,"When you reach 6th level, using 2 AP, you can magically force a Large or smaller creature you can see within 60 feet of you to make a Constitution saving throw against your spell save DC. Unless the saving throw is a success, the creature is encased in a field of magical energy until the end of your next turn or until the creature takes any damage. While encased in this way, the creature is incapacitated and has a speed of 0.

You can use this feature a number of times equal to your Intelligence modifier (a minimum of once). You regain all expended uses when you finish a long rest.",
Arcane Abeyance,Magic,"Wizard, Chronurgy Magic",4,10,,"At 10th level, when you cast a spell using a spell slot of 4th level or lower, you can condense the spell's magic into a mote. The spell is frozen in time at the moment of casting and held within a gray bead for 1 hour. This bead is a Tiny object with AC 15 and 1 hit point, and it is immune to poison and psychic damage. When the duration ends, or if the bead is destroyed, it vanishes in aflash of light, and the spell is lost.
...
Tactical Wit,Magic,"Wizard, War Magic",6,2,,"Starting at 2nd level, your keen ability to assess tactical situations allows you to act quickly in battle. You can give yourself a bonus to your initiative rolls equal to your Intelligence modifier.",
Power Surge,Magic,"Wizard, War Magic",3,6,,"Starting at 6th level, you can store magical energy within yourself to later empower your damaging spells.
...
,Dragon Fear,Dragonborn,"+1 in Str., Con., or Cha. and your Breath Weapon can frighten instead of inflicting damages.",4,
,Dragon Hide,Dragonborn,"+1 in Str., Con., or Cha., your AC becomes 13+Dex. modifier and your retractable claws deal 1d4+Str. modifier slashing damage.",4,
...
,Moderately Armored,Proficiency with light armor,+1 in Str. or Dex. and you gain proficiency with medium armor and shields.,3,
,Mounted Combatant,-,Advantage on melee attacks against unmounted creature and force an attack to target you instead of your mount.,4,
...
,Ritual Caster,"Intelligence, Wisdom or Cha 13 or higher","• +1 to INT, WIS or CHA
• Ritual Spells: Choose two 1st-level Spells that have the Ritual tag. You always have those two Spells prepared, and you can cast them with any Spell Slots you have. The Spells’ Spellcasting Ability is the ability increased by this Feat. Whenever your Proficiency Bonus increase thereafter, you can add an additional leve 1 spell with the Ritual tag to the spells always preparaed with this feature.
• Quick Ritual - With this benefit, you can cast a Ritual Spell that you have prepared using its regular casting time, rather than the extended time for a Ritual. Doing so doesn’t require a Spell Slot. Once you cast the Spell in this way, you can’t use this benefit again until you finish a Long Rest",4,
,Rune Shaper,Spellcasting feature or Rune Carver background,You learn comprehend languages and 1/2 PB 1st-level spells (cast with rune or spell slot).,4,
,Savage Attacker,-,"Once per turn when you hit a target wuth a weapon, you can roll the weapon's damage dice twice and use either roll against the target",3,
...
,Sneak Master,Stealth proficiency and Cunning Action,"• You became expert in Stealth check
• When you use the Sneak Action you can move at full speed.",4,
,Soul of the Storm Giant,"4th Level, Strike of the Giants (Storm Strike) feat","+1 in Str., Con., or Wis.; resistance to lightning and thunder damage ; disadvantage vs you ; 1/2 speed (PB/day).",4,
...
• Il caster inoltre ottiene la capacità di mantenere la carica: il caster può mantenere la carica di un incantesimo che richiede uno spell strike che ha una durata istantanea. Mantenere la carica richiede concentrazione al caster.",5,
...
Great Weapon Fighting,,"When you roll damage for an attack you make with a Melee weapon that you are holding with two hands, you add your mod of Strenght 2 times on damage rolls. The weapon must have the Two-Handed or Versatile property to gain this benefit."
Interception,Reaction," When a creature you can see hits a target, other than you, within 5 feet of you with an attack, you can use your reaction to reduce the damage the target takes by your score of Strenght or Dexterity, at your choice (to a minimum of 0 damage). You must be wielding a shield or a simple or martial weapon to use this reaction. You can use this reaction 2 times in the same turn."
Protection,Reaction," When a creature you can see attacks a target other than you that is within 5 feet of you, you can use your reaction to interpose your Shield if you are holding one. You impose Disadvantage on the triggering attack roll and all other attack rolls until the start of your next turn if you remain within 5 ft of the target."
...
Withdraw,1d6,"Lev. 5 - Cost: 1d6. Immediately after the attack, you move up to half your Speed without provoking Opportunity Attacks."
Daze,2d6,"Lev. 14 - Cost: 2d6. The target must succeed on a Constitution saving throw, or on its next turn, it has the Dazed condition."
Knock Out,6d6,"Lev. 14 - Cost: 6d6. The target must succeed on a Constitution saving throw, or it has the Unconscious condition for 1 minute or until it takes any damage. The Unconscious target repeats the save at the end of each of its turns, ending the effect on a success."
Obscure,3d6,"Lev. 14 - Cost: 3d6. The target must succeed on a Dexterity saving throw, or it has the Blinded condition until the end of its next turn."
Stealth Attack,1d6,"Lev. 9 - Cost: 1d6. If you have the Hide action's Invisible condition, this attack doesn't end that condition on you if you end the turn behind Three-Quarters Cover or Total Cover."`;
...
Subtle Spell,1 SP,"When you cast a spell, you can spend 1 sorcery point to cast it without any somatic or verbal components."
Transmuted Spell,1 SP,"When you cast a spell that deals a type of damage from the following list, you can spend 1 sorcery point to change that damage type to one of the other listed types: acid, cold, fire, lightning, poison, thunder."
Twinned Spell,1 SP x Spell Level,"When you cast a spell that targets only one creature and doesn't have a range of self, you can spend a number of sorcery points equal to the spell's level to target a second creature in range with the same spell (1 sorcery point if the spell is a cantrip). To be eligible, a spell must be incapable of targeting more than one creature at the spell's current level. For example, magic missile and scorching ray aren't eligible, but ray of frost and chromatic orb are."
Maximize Spell,2 SP,Il danno dell'incantesimo è massimizzato. Ad esempio se il danno è 3d10 il danno totale sarà 30. 2 S.P.
Empowered Spell,1 SP,"1 S.P. All variable, il numero di dadi dell'incantesimo viene aumentato della metà arrotondato per difetto."
Insightful Spell,1 SP,"1 S.P. 
Il caster può cambiare il TS del proprio incantesimo basandolo su un'altra caratteristica della stessa famiglia, fisica (STR, DEX o CON) o mentale (INT, WIS, CHA).
Questo si applica al solo tiro salvezza primario. Se lo spell prevede un altro TS per un effetto secondario, quello rimane invariato.
...
Barbarian Proficiency,Barbarian,7,"6pf per livello\nArmor: Light armor, medium armor, shields\nWeapons: Simple weapons, martial weapons\nTools: None\nSaving Throws: Strength, Constitution\nSkills: Choose two from Animal Handling, Athletics, Intimidation, Nature, Perception, and Survival"
Bard Proficiency,Bard,5,"4pf per livello\nArmor: Light armor\nWeapons: Simple weapons, hand crossbows, longswords, rapiers, shortswords\nTools: Three musical instruments of your choice\nSaving Throws: Dexterity, Charisma\nSkills: Choose any three"
Cleric Proficiency,Cleric,6,"4pf per livello\nArmor: Light armor, medium armor, shields\nWeapons: All simple weapons\nTools: None\nSaving Throws: Wisdom, Charisma\nSkills: Choose two from History, Insight, Medicine, Persuasion, and Religion"
Druid Proficiency,Druid,5,"4pf per livello\nArmor: Light armor, medium armor, shields\nWeapons: Clubs, daggers, darts, javelins, maces, quarterstaffs, scimitars, sickles, slings, spears\nTools: Herbalism kit\nSaving Throws: Intelligence, Wisdom\nSkills: Choose two from Arcana, Animal Handling, Insight, Medicine, Nature, Perception, Religion, and Survival"
Fighter Proficiency,Fighter,8,"5pf per livello\nArmor: All armor, shields\nWeapons: Simple weapons, martial weapons\nTools: None\nSaving Throws: Strength, Constitution\nSkills: Choose two skills from Acrobatics, Animal Handling, Athletics, History, Insight, Intimidation, Perception, and Survival"
Monk Proficiency,Monk,4,"4pf per livello\nArmor: None\nWeapons: Simple weapons, shortswords\nTools: Choose one type of artisan's tools or one musical instrument\nSaving Throws: Strength, Dexterity\nSkills: Choose two from Acrobatics, Athletics, History, Insight, Religion, and Stealth"
Paladin Proficiency,Paladin,8,"5pf per livello\nArmor: All armor, shields\nWeapons: Simple weapons, martial weapons\nTools: None\nSaving Throws: Wisdom, Charisma\nSkills: Choose two from Athletics, Insight, Intimidation, Medicine, Persuasion, and Religion"
Ranger Proficiency,Ranger,8,"5pf per livello\nArmor: Light armor, medium armor, shields\nWeapons: Simple weapons, martial weapons\nTools: None\nSaving Throws: Strength, Dexterity\nSkills: Choose three from Animal Handling, Athletics, Insight, Investigation, Nature, Perception, Stealth, and Survival"
Rogue Proficiency,Rogue,6,"4pf per livello\nArmor: Light armor\nWeapons: Simple weapons, hand crossbows, longswords, rapiers, shortswords\nTools: Thieves' tools\nSaving Throws: Dexterity, Intelligence\nSkills: Choose four from Acrobatics, Athletics, Deception, Insight, Intimidation, Investigation, Perception, Performance, Persuasion, Sleight of Hand, and Stealth"
Sorcerer Proficiency,Sorcerer,2,"3pf per livello\nArmor: None\nWeapons: Daggers, darts, slings, quarterstaffs, light crossbows\nTools: None\nSaving Throws: Constitution, Charisma\nSkills: Choose two from Arcana, Deception, Insight, Intimidation, Persuasion, and Religion"
Warlock Proficiency,Warlock,4,"4pf per livello\nWeapons: Simple weapons\nTools: None\nSaving Throws: Wisdom, Charisma\nSkills: Choose two from Arcana, Deception, History, Intimidation, Investigation, Nature, and Religion"
Wizard Proficiency,Wizard,2,"3pf per livello\nArmor: None\nWeapons: Daggers, darts, slings, quarterstaffs, light crossbows\nTools: None\nSaving Throws: Intelligence, Wisdom\nSkills: Choose two from Arcana, History, Insight, Investigation, Medicine, and Religion"
Vampire Proficiency,Vampire,5,"5pf per livello\nArmor: None\nWeapon: Simple weapons, martial weapons\nTools: None\nSaving Throw: Dexterity, Charisma\nSkill: Choose any three"
Psion Proficiency,Psion,2,"3pf per livello\nArmor: None\nWeapons: Daggers, darts, slings, quarterstaffs, light crossbows\nTools: None\nSaving Throws: Intelligence, Wisdom\nSkills: Choose two from Arcana, History, Insight, Investigation, Medicine, and Religion"
Blood-Hunter Proficiency,Blood-Hunter,8,"5pf per livello\nArmor: Light armor, medium armor, shields\nWeapons: Simple weapons, martial weapons\nTools: Alchemist's Supplies\nSaving Throws: Dexterity, Intelligence\nSkills: Choose three from Acrobatics, Arcana, Athletics, History, Insight, Investigation, Religion and Survival"`;

        const POINT_BUY_COSTS = { 8: 0, 9: 1, 10: 2, 11: 3, 12: 4, 13: 5, 14: 7, 15: 9 };
        const DEFAULT_STATS = {
            STR: { base: 8, race: 0, feat: 0, ability: 0, misc: 0 },
            DEX: { base: 8, race: 0, feat: 0, ability: 0, misc: 0 },
            CON: { base: 8, race: 0, feat: 0, ability: 0, misc: 0 },
            INT: { base: 8, race: 0, feat: 0, ability: 0, misc: 0 },
            WIS: { base: 8, race: 0, feat: 0, ability: 0, misc: 0 },
        ...
        const CLASS_REQUIREMENTS = {
            ...
            "Bard": { text: "Cha 13", check: (s) => s.CHA >= 13 },
            "Blood-Hunter": { text: "Str/Dex 13, Int 13", check: (s) => (s.STR >= 13 || s.DEX >= 13) && s.INT >= 13 },
            "Cleric": { text: "Wis 13", check: (s) => s.WIS >= 13 },
            "Druid": { text: "Wis 13", check: (s) => s.WIS >= 13 },
            "Fighter": { text: "Str or Dex 13", check: (s) => s.STR >= 13 || s.DEX >= 13 },
            "Monk": { text: "Dex 13, Wis 13", check: (s) => s.DEX >= 13 && s.WIS >= 13 },
            "Paladin": { text: "Str 13, Cha 13", check: (s) => s.STR >= 13 && s.CHA >= 13 },
            "Psion": { text: "Int 13", check: (s) => s.INT >= 13 },
        ...
        const FIXED_CLASSES_LIST = [
            "Artificier", "Barbarian", "Bard", "Blood-Hunter", "Cleric", 
            "Druid", "Fighter", "Monk", "Paladin", "Psion", 
            "Ranger", "Rogue", "Sorcerer", "Vampire", "Warlock", "Wizard"
        ];
